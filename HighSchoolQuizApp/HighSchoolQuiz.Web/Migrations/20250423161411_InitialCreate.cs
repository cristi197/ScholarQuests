        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_HighSchools_HighSchoolId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkProblems", x => new { x.HomeworkId, x.ProblemId });
                    table.ForeignKey(
                        name: "FK_HomeworkProblems_Homeworks_HomeworkId",
                        column: x => x.HomeworkId,
                        principalTable: "Homeworks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HomeworkProblems_Problems_ProblemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Solutions", x => new { x.ProblemId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_HighSchoolId",
                table: "Classes",
                column: "HighSchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_Classes_Name_HighSchoolId",
                table: "Classes",
                columns: new[] { "Name", "HighSchoolId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkProblems_ProblemId",
                table: "HomeworkProblems",
                column: "ProblemId");
